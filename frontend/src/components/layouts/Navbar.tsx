    ...
    <header className="sticky top-0 z-30 bg-white/90 dark:bg-[#0F172A]/90 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 px-4 sm:px-6 lg:px-8 transition-colors">
      <div className="max-w-7xl mx-auto h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-950 flex items-center justify-center font-bold text-lg shadow-sm group-hover:scale-105 transition-transform">
              <Sparkles className="w-5 h-5 fill-current" />
            </div>
            <div className="flex flex-col">
              <span className="font-extrabold text-base tracking-tight text-slate-950 dark:text-white leading-none">
                KAIROS
              </span>
              <span className="text-[10px] font-semibold tracking-wider uppercase text-slate-500 dark:text-slate-400 mt-0.5">
        ...
        {/* Center: Top Pill Tab Navigation (Reference Screenshot Style) */}
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          {/* Active Quota Pill */}
          <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 text-xs font-medium text-slate-700 dark:text-slate-300">
          ...
          <button
            ...
            className="p-2 text-slate-500 hover:text-red-600 dark:text-slate-400 dark:hover:text-red-400 bg-slate-100 dark:bg-slate-800/80 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-lg border border-slate-200/80 dark:border-slate-700 transition-colors flex items-center gap-1.5 text-xs font-medium"
            title="Exit Session"
          >
