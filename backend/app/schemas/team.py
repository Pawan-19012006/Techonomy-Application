...
class TeamResponse(BaseModel):
    ...
    timer_remaining_seconds: int = Field(default=7200, description="Remaining session time in seconds")
    session_duration_seconds: int = Field(default=7200, description="Total competition session duration")
